...
export default function LionsSeason3() {
    ...
    <div className="bg-[#FFFFFF] min-h-screen text-[#0B1E4A] font-sans overflow-hidden">
      ...
      <section className="relative min-h-[70dvh] flex flex-col items-center justify-center overflow-hidden pt-32 pb-12">
        ...
        <div className="relative z-10 text-center px-6 max-w-5xl mx-auto flex flex-col items-center">
          ...
          >
            Lions <span className="text-[#FFC300] drop-shadow-sm">Season 3</span>
          </motion.h1>
          ...
          >
            A Return with Greater Confidence
          </motion.p>
        ...
        <div className="max-w-[1200px] mx-auto px-6 md:px-12 text-center">
          ...
          >
            <h2 className="text-4xl md:text-5xl font-display font-bold italic uppercase tracking-tight mb-8 text-[#0B1E4A]">
              Progress & <span className="text-[#FFC300] underline decoration-[#FFC300]/40 underline-offset-8">Consistency</span>
            </h2>
            <div className="space-y-6 text-[#0B1E4A]/80 text-xl leading-relaxed font-medium max-w-4xl mx-auto">
              <p>
                Season 3 of the World Padel League saw Game Changers Lions return with greater confidence and a clearer sense of direction.
              </p>
              <p className="border-l-4 border-[#FFC300] pl-6 text-left py-2 font-bold text-[#0B1E4A] bg-[#F1F5F9] p-6 shadow-sm">
                With growing experience and exposure, the Lions continued to strengthen their presence in the league while contributing to the sport’s visibility in India. The season reflected progress, consistency, and the franchise’s ongoing commitment to developing padel as a mainstream sport.
              </p>
            </div>
          </motion.div>
        </div>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-20 items-center">
            ...
            >
              ...
              <h2 className="text-4xl md:text-5xl font-display font-black italic uppercase text-[#0B1E4A] mb-8 leading-tight">
                Improved <br /> <span className="text-[#FFC300] drop-shadow-sm">Cohesion</span>
              </h2>
              ...
              <div className="space-y-6 text-[#0B1E4A]/80 text-lg leading-relaxed font-medium bg-white p-8 border border-slate-200 shadow-sm relative overflow-hidden">
                ...
                <p className="relative z-10">
                  Building on their debut season, the team entered the tournament with improved cohesion and a stronger competitive mindset.
                </p>
                <p className="relative z-10">
                  Equipped with the lessons learned from their inaugural year, the Lions united to face new challenges head-on. The collective squad demonstrated higher levels of synergy on the court, proving their evolution as a competitive force within the World Padel League.
                </p>
              </div>
            </motion.div>
            ...
            >
              <div className="relative p-3 md:p-4 bg-white shadow-xl rotate-1 hover:rotate-0 transition-transform duration-500 border border-slate-200">
                ...
                <div className="aspect-[3/4] md:aspect-[4/5] relative overflow-hidden bg-[#F1F5F9]">
                  ...
                  <img
                    src="https://res.cloudinary.com/dtsuewnbj/image/upload/v1776878669/IMG-20260422-WA0005_dyuqmr.jpg"
          ...
          >
            <div>
              ...
              <h2 className="text-4xl md:text-6xl lg:text-7xl font-display font-bold italic uppercase text-[#0B1E4A] tracking-tighter leading-none">
                Season 3 <span className="text-[#FFC300]">Gallery</span>
              </h2>
            </div>
          </motion.div>
        </div>
