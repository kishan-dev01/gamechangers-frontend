...
export default function FalconsSeason2024() {
  ...
  const squad = [
    ...
    { name: "Elena Rybakina", image: "https://res.cloudinary.com/dtsuewnbj/image/upload/v1776854123/elena_jnnzxx.jpg" },
    { name: "Denis Shapovalov", image: "https://res.cloudinary.com/dtsuewnbj/image/upload/v1776854124/denis_z1qeao.jpg" },
